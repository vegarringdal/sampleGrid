...
import { initPositionHandler } from "./initPositionHandler";
import { resizeHandler } from "./resizeHandler";
import { MinMaximizeIcon } from "./minMaximizeIcon";
  ...
  return (
    <div className={classname}>
      ...
      >
        ...
        >
          <span className="m-auto p-1 text-base dark:text-white">
            {props.title}
          </span>
        ...
        <div className="absolute bottom-0 left-0 right-0 top-0 z-[-10]">
          ...
          <div
            ...
            onPointerDown={(e) =>
              resizeHandler(e, "top-left", sizeState, setDataState)
            }
          ></div>
          <div
          ...
          <div
            ...
            onPointerDown={(e) =>
              resizeHandler(e, "bottom", sizeState, setDataState)
            }
          ></div>
          ...
          <div
            ...
            onPointerDown={(e) =>
              resizeHandler(e, "top", sizeState, setDataState)
            }
          ></div>
          ...
          <div
            ...
            onPointerDown={(e) =>
              resizeHandler(e, "left", sizeState, setDataState)
            }
          ></div>
          ...
          <div
            ...
            onPointerDown={(e) =>
              resizeHandler(e, "right", sizeState, setDataState)
            }
          ></div>
        </div>
      </div>
