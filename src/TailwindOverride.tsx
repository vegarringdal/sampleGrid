...
`,
  ...
  panel: {
    header: ({ props }) => ({
      className: classNames(
        ...
        "dark:bg-gray-800 dark:border-blue-900/40 dark:text-white/80", // Dark mode
    ...
    accordiontab: {
      ...
      headerAction: ({ context }) => ({
        className: classNames(
          ...
          "dark:bg-gray-800 dark:border-blue-900/40 dark:text-white/80 dark:hover:bg-gray-800/80 dark:focus:shadow-[inset_0_0_0_0.2rem_rgba(147,197,253,0.5)]", // Dark mode
  ...
  card: {
    root: {
      className: classNames(
        ...
        "dark:bg-gray-800 dark:text-white " //dark
      ),
    },
    body: "p-5", // Padding.
  ...
  divider: {
    ...
    content: "px-1 bg-white z-10 dark:bg-gray-800", // Padding and background color.
  },
  fieldset: {
    root: {
      className: classNames(
        ...
        "dark:bg-gray-800 dark:border-blue-900/40 dark:text-white/80" //dark
      ),
    },
    legend: ({ props }) => ({
      className: classNames(
  ...
  tabview: {
    ...
    previousButton: {
      className: classNames(
        ...
        "dark:bg-gray-800 dark:border-blue-900/40 dark:text-white/80 )"
    ...
    headerAction: ({ parent, context }) => ({
      className: classNames(
        ...
        //"focus:outline-none focus:outline-offset-0 focus:shadow-[inset_0_0_0_0.2rem_rgba(191,219,254,1)] dark:focus:shadow-[inset_0_0_0_0.2rem_rgba(147,197,253,0.5)]", // Focus styles.
        {
          ...
          "bg-white border-blue-500 text-blue-500 dark:bg-gray-800 dark:border-blue-300 dark:text-blue-300":
  ...
  splitter: {
    root: ({ props, state }) => ({
      className: classNames(
        "flex flex-nowrap bg-white dark:bg-gray-800 rounded-lg text-gray-700 dark:text-white/80",
        {
  ...
  dialog: {
    ...
    header: {
      className: classNames(
        ...
        "dark:bg-gray-800  dark:text-white/80"
      ),
    },
  ...
  confirmdialog: {
    root: {
      className: classNames(
        ...
        "dark:border dark:border-blue-900/40 dark:bg-gray-800  dark:text-white/80"
      ),
    },
  ...
  fileupload: {
    ...
    content: {
      className: classNames(
        "relative",
        "bg-white dark:bg-gray-800 p-8 border border-gray-300 dark:border-blue-900/40 text-gray-700 dark:text-white/80 rounded-b-lg"
      ),
    },
    file: {
      className: classNames(
  ...
  inputtext: {
    root: ({ props, context }) => ({
      className: classNames(
        "m-0",
        "font-sans text-gray-600 dark:text-white/80 bg-white dark:bg-gray-800 border transition-colors duration-200 appearance-none rounded-lg",
        {
  ...
  inputswitch: {
    ...
    slider: ({ props }) => ({
      className: classNames(
        ...
        "focus:outline-none focus:outline-offset-0 focus:shadow-[0_0_0_0.2rem_rgba(191,219,254,1)] dark:focus:shadow-[0_0_0_0.2rem_rgba(147,197,253,0.5)]",
        "before:absolute before:content-'' before:top-1/2 before:bg-white before:dark:bg-gray-800 before:w-5 before:h-5 before:left-1 before:-mt-2.5 before:rounded-full before:transition-duration-200",
        {
  ...
  cascadeselect: {
    root: ({ props }) => ({
      className: classNames(
        ...
        "bg-white dark:bg-gray-800 border border-gray-300 dark:border-blue-900/40 transition duration-200 ease-in-out rounded-lg",
        {
          "opacity-60 select-none pointer-events-none cursor-default":
            props.disabled,
        }
    ...
    panel: "py-3 bg-white dark:bg-gray-800 border-0 shadow-md",
    ...
    sublist: {
      className: classNames(
        "py-3 bg-white dark:bg-gray-800 border-0 shadow-md"
      ),
    },
    item: ({ state }) => ({
      className: classNames(
  ...
  selectbutton: {
    ...
    button: ({ context }) => ({
      className: classNames(
        ...
        "focus:outline-none focus:outline-offset-0 focus:shadow-[0_0_0_0.2rem_rgba(191,219,254,1)] dark:focus:shadow-[0_0_0_0.2rem_rgba(147,197,253,0.5)]",
        {
          "bg-white dark:bg-gray-800 text-gray-700 dark:text-white/80 border-gray-300 dark:border-blue-900/40 hover:bg-gray-50 dark:hover:bg-gray-800/80 ":
            !context.selected,
  ...
  password: {
    ...
    panel:
      "p-5 bg-white dark:bg-gray-800 text-gray-700 dark:text-white/80 shadow-md rounded-md",
  ...
  togglebutton: {
    root: ({ props, state }) => ({
      className: classNames(
        ...
        {
          "bg-white dark:bg-gray-800 border-gray-300 dark:border-blue-900/40 text-gray-700 dark:text-white/80 hover:bg-gray-100 dark:hover:bg-gray-800/80 hover:border-gray-300 dark:hover:bg-gray-800/70 hover:text-gray-700 dark:hover:text-white/80":
            !props.checked,
    ...
    box: ({ props }) => ({
      className: classNames(
        ...
        "border-2 w-6 h-6 rounded-lg transition-colors duration-200",
        {
          ...
          "border-gray-300 text-gray-600 bg-white dark:border-blue-900/40 dark:bg-gray-800":
            props.value == null,
        },
        {
  ...
  checkbox: {
    ...
    box: ({ props, context }) => ({
      className: classNames(
        ...
        {
          "border-gray-300 bg-white dark:border-blue-900/40 dark:bg-gray-800":
            !context.checked,
  ...
  radiobutton: {
    ...
    box: ({ props }) => ({
      className: classNames(
        ...
        {
          "border-gray-300 bg-white dark:border-blue-900/40 dark:bg-gray-800 dark:text-white/80":
            !props.checked,
          "border-blue-500 bg-blue-500 dark:border-blue-400 dark:bg-blue-400":
            props.checked,
        },
    ...
    icon: ({ props }) => ({
      className: classNames(
        ...
        "block w-3 h-3 transition duration-200 bg-white dark:bg-gray-800",
        {
  ...
  dropdown: {
    ...
    wrapper: {
      className:
        "max-h-[200px] overflow-auto bg-white text-gray-700 border-0 rounded-md shadow-lg dark:bg-gray-800 dark:text-white/80",
    },
    ...
    filterInput: {
      className: classNames(
        ...
        "dark:bg-gray-800 dark:border-blue-900/40 dark:hover:border-blue-300 dark:text-white/80",
        "hover:border-blue-500 focus:outline-none focus:outline-offset-0 focus:shadow-[0_0_0_0.2rem_rgba(191,219,254,1)] dark:focus:shadow-[0_0_0_0.2rem_rgba(147,197,253,0.5)]"
      ),
    },
  ...
  calendar: {
    ...
    input: {
      root: ({ parent }) => ({
        className: classNames(
          "font-sans text-base text-gray-600 dark:text-white/80 bg-white dark:bg-gray-800 p-3 border border-gray-300 dark:border-blue-900/40 transition-colors duration-200 appearance-none",
    ...
    panel: ({ props }) => ({
      className: classNames(
        ...
        "top-0 left-0 w-auto min-w-min p-2 rounded-lg",
        {
          ...
          "inline-block overflow-x-auto border border-gray-300 dark:border-blue-900/40":
            props.inline,
        }
      ),
    }),
    header: {
      className: classNames(
        ...
        "p-2 text-gray-700 dark:text-white/80 bg-white dark:bg-gray-800 font-semibold m-0 border-b border-gray-300 dark:border-blue-900/40 rounded-t-lg"
      ),
    },
    previousButton: {
      className: classNames(
  ...
  listbox: {
    root: {
      className: classNames(
        "bg-white dark:bg-gray-800 border border-gray-400 dark:border-blue-900/40 transition-colors duration-200 ease-in-out rounded-md",
        "w-full md:w-56"
      ),
    },
  ...
  mention: {
    root: "relative",
    panel:
      "max-h-[200px] min-w-full overflow-auto bg-white dark:bg-gray-800 text-gray-700 dark:text-white/80 border-0 rounded-md shadow-lg",
  ...
  multiselect: {
    ...
    panel: {
      className: classNames(
        "bg-white dark:bg-gray-800 text-gray-700 dark:text-white/80 border-0 rounded-md shadow-lg"
      ),
    },
    header: {
      className: classNames(
    ...
    headerCheckbox: {
      root: ({ props }) => ({
        className: classNames(
          ...
          "hover:border-blue-500 focus:outline-none focus:outline-offset-0 focus:shadow-[0_0_0_0.2rem_rgba(191,219,254,1)] dark:focus:shadow-[0_0_0_0.2rem_rgba(147,197,253,0.5)]",
          {
            "border-gray-300 dark:border-blue-900/40 bg-white dark:bg-gray-800":
              !props?.checked,
  ...
  inputtextarea: {
    root: ({ context }) => ({
      className: classNames(
        "m-0",
        "font-sans text-base text-gray-600 dark:text-white/80 bg-white dark:bg-gray-800 p-3 border border-gray-300 dark:border-blue-900/40 transition-colors duration-200 appearance-none rounded-lg",
        "hover:border-blue-500 focus:outline-none focus:outline-offset-0 focus:shadow-[0_0_0_0.2rem_rgba(191,219,254,1)] dark:focus:shadow-[0_0_0_0.2rem_rgba(147,197,253,0.5)]",
        {
          "opacity-60 select-none pointer-events-none cursor-default":
            context.disabled,
  ...
  autocomplete: {
    ...
    container: {
      className: classNames(
        ...
        "px-3 py-2 gap-2",
        "font-sans text-base text-gray-700 dark:text-white/80 bg-white dark:bg-gray-800 border border-gray-300 dark:border-blue-900/40  transition duration-200 ease-in-out appearance-none rounded-md",
    ...
    input: ({ props }) => ({
      root: {
        className: classNames(
          ...
          {
            "font-sans text-base text-gray-700 dark:text-white/80 bg-white dark:bg-gray-800 p-3 border border-gray-300 dark:border-blue-900/40 focus:outline-offset-0 focus:shadow-[0_0_0_0.2rem_rgba(191,219,254,1)] dark:focus:shadow-[0_0_0_0.2rem_rgba(147,197,253,0.5)] hover:border-blue-500 focus:outline-none":
              !props.multiple,
  ...
  chips: {
    ...
    container: {
      className: classNames(
        ...
        "w-full",
        "font-sans text-base text-gray-600 dark:text-white/70 bg-white dark:bg-gray-800 p-3 border border-gray-300 dark:border-blue-900/40 transition-colors duration-200 appearance-none rounded-lg",
        "hover:border-blue-500 focus:outline-none focus:outline-offset-0 focus:shadow-[0_0_0_0.2rem_rgba(191,219,254,1)] dark:focus:shadow-[0_0_0_0.2rem_rgba(147,197,253,0.5)]"
      ),
    },
    inputToken: {
  ...
  colorpicker: {
    ...
    input: {
      className: classNames(
        "m-0",
        "font-sans text-base text-gray-600 bg-white dark:bg-gray-800 p-3 border border-gray-300 dark:border-blue-900/40 transition-colors duration-200 rounded-lg cursor-pointer",
        "hover:border-blue-500 focus:outline-none focus:outline-offset-0 focus:shadow-[0_0_0_0.2rem_rgba(191,219,254,1)] dark:focus:shadow-[0_0_0_0.2rem_rgba(147,197,253,0.5)]",
        "w-8 h-8"
      ),
    },
  ...
  chip: {
    root: {
      className: classNames(
        "inline-flex items-center",
        "bg-gray-200 text-gray-800 rounded-[16px] px-3 dark:text-white/80 dark:bg-gray-800"
      ),
    },
  ...
  breadcrumb: {
    root: {
      className: classNames(
        "overflow-x-auto",
        "bg-white dark:bg-gray-800 border border-gray-300 dark:border-blue-900/40 rounded-md p-4"
      ),
    },
  ...
  contextmenu: {
    root: "py-1 bg-white dark:bg-gray-800 text-gray-700 dark:text-white/80 border-none shadow-md rounded-lg w-52",
    menu: {
  ...
  menu: {
    root: "py-1 bg-white dark:bg-gray-800 text-gray-700 dark:text-white/80 border border-gray-300 dark:border-blue-900/40 rounded-md w-48",
    menu: {
      className: classNames("m-0 p-0 list-none", "outline-none"),
    },
    content: ({ state }) => ({
    ...
    submenuHeader: {
      className: classNames(
        "m-0 p-3 text-gray-700 dark:text-white/80 bg-white dark:bg-gray-800 font-bold rounded-tl-none rounded-tr-none"
      ),
    },
  ...
  menubar: {
    root: {
      className: classNames(
        "p-2 bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-blue-900/40 rounded-md",
    ...
    menu: ({ state }) => ({
      className: classNames(
        ...
        "absolute py-1 bg-white dark:bg-gray-800 border-0 shadow-md w-full",
        {
    ...
    submenu: ({ props }) => ({
      className: classNames(
        "py-1 bg-white dark:bg-gray-800 border-0  sm:shadow-md sm:w-48",
  ...
  megamenu: {
    root: ({ props }) => ({
      className: classNames(
        "bg-gray-100 dark:bg-gray-800  border border-gray-300 dark:border-blue-900/40  rounded-md",
        "flex relative",
        {
    ...
    panel: ({ props }) => ({
      className: classNames(
        "py-1 bg-white dark:bg-gray-800 border-0 shadow-md w-auto",
        "absolute z-10",
        {
    ...
    submenuHeader: {
      className: classNames(
        "m-0 py-3 px-5 text-gray-700 dark:text-white/80 bg-white dark:bg-gray-800 font-semibold rounded-tr-md rounded-tl-md"
      ),
    },
  },
  panelmenu: {
    ...
    header: {
      className: classNames(
        "outline-none",
        "focus:outline-none focus:outline-offset-0 focus:shadow-[0_0_0_0.2rem_rgba(191,219,254,1)] dark:focus:shadow-[0_0_0_0.2rem_rgba(147,197,253,0.5)]",
        "border border-solid border-gray-300 dark:border-blue-900/40 text-gray-700 dark:text-white/80 bg-gray-100 dark:bg-gray-800 rounded-md transition-shadow duration-200",
    ...
    menuContent: {
      className: classNames(
        "py-1 border border-t-0 border-gray-300 dark:border-blue-900/40 bg-white dark:bg-gray-800 text-gray-700 dark:text-white/80 rounded-t-none rounded-br-md rounded-bl-md"
      ),
    },
    menu: {
  ...
  steps: {
    ...
    step: ({ parent, context }) => ({
      className: classNames(
        "flex items-center justify-center",
        "text-gray-700 dark:text-white/80 border border-gray-300 dark:border-blue-900/40 bg-white dark:bg-gray-800 w-[2rem] h-[2rem] leading-2rem text-sm z-10 rounded-full",
        {
  ...
  slidemenu: {
    root: {
      className: classNames(
        ...
        "dark:border-blue-900/40 dark:bg-gray-800"
      ),
    },
    ...
    submenu: {
      className: classNames(
        "py-1 bg-white dark:bg-gray-800 border-0 shadow-md min-w-full",
        "absolute z-10",
        "left-full top-0"
      ),
    },
  ...
  metergroup: {
    ...
    labellisttype: {
      className:
        "inline-flex bg-primary-500 dark:bg-primary-400 w-2 h-2 rounded-full",
    },
  },
  //MEDIA
  image: {
  ...
  tree: {
    root: ({ props }) => ({
      className: classNames(
        ...
        "bg-white dark:bg-gray-800 text-gray-700 dark:text-white/80 p-5",
        {
    ...
    input: {
      className: classNames(
        ...
        "font-sans text-gray-600 dark:text-white/70 bg-white dark:bg-gray-800 border border-gray-300 dark:border-blue-900/40 transition-colors duration-200 appearance-none rounded-lg",
        "hover:border-blue-500 focus:outline-none focus:outline-offset-0 focus:shadow-[0_0_0_0.2rem_rgba(191,219,254,1)] dark:focus:shadow-[0_0_0_0.2rem_rgba(147,197,253,0.5)]"
      ),
    },
    searchIcon:
  ...
  dataview: {
    content: {
      className: classNames(
        ...
        "dark:bg-gray-800 dark:text-white/80" // Dark Mode
      ),
    },
    grid: "flex flex-wrap ml-0 mr-0 mt-0 bg-white dark:bg-gray-800",
    header:
    ...
    listButton: ({ props }) => ({
      className: classNames(
        ...
        props.layout === "list"
          ...
          : "bg-white border-gray-300 text-blue-gray-700 dark:bg-gray-800 dark:border-blue-900/40 dark:text-white/80" // highlighted state
      ),
    }),
    gridButton: ({ props }) => ({
      className: classNames(
  ...
  organizationchart: {
    ...
    node: {
      className: classNames(
        ...
        "dark:border-blue-900/40 dark:bg-gray-800 dark:text-white/80" // Dark Mode
      ),
    },
  ...
  orderlist: {
    ...
    header: {
      className: classNames(
        ...
        "dark:bg-gray-800 dark:text-white/80 dark:border-blue-900/40" //Dark Mode
      ),
    },
    list: {
      className: classNames(
  ...
  paginator: {
    root: {
      className: classNames(
        ...
        "dark:bg-gray-800 dark:text-white/60 dark:border-blue-900/40" // Dark Mode
      ),
    },
    ...
    RPPDropdown: {
      root: ({ props, state }) => ({
        className: classNames(
          ...
          "transition duration-200",
          "h-12 mx-2",
          "dark:bg-gray-850 dark:border-blue-900/40", //DarkMode
          {
    ...
    JTPInput: {
      ...
      input: {
        className: classNames(
          ...
          "dark:text-white dark:bg-gray-850 dark:border-blue-900/40", //Dark Mode
  ...
  treetable: {
    ...
    header: {
      className: classNames(
        ...
        "dark:bg-gray-800 dark:text-white/70 dark:border-blue-900/40" // Dark Mode
      ),
    },
    ...
    row: ({ context }) => ({
      className: classNames(
        ...
        context.selected
          ? "bg-blue-50 text-blue-700 dark:bg-blue-300 dark:text-white/80"
          : "bg-white text-gray-600 dark:bg-gray-800 dark:text-white/80",
        {
    ...
    column: {
      headerCell: ({ context }) => ({
        className: classNames(
          ...
          "dark:border-blue-900/40 dark:text-white/80 dark:bg-gray-800", //Dark Mode
          {
  ...
  datatable: {
    ...
    column: {
      headerCell: ({ context, props }) => ({
        className: classNames(
          ...
          context.sorted
            ...
            : "dark:text-white/80 dark:bg-gray-800", // Dark Mode
          {
      ...
      footerCell: ({ context }) => ({
        className: classNames(
          ...
          context?.size === "small"
            ...
            ? "p-5"
            : "p-4", // Size
          "dark:text-white/80 dark:bg-gray-800 dark:border-blue-900/40", // Dark Mode
          {
            "border-x border-y": context.showGridlines,
          }
        ),
      ...
      filterMenuButton: ({ context }) => ({
        className: classNames(
          ...
          "dark:text-white/70 dark:hover:text-white/80 dark:bg-gray-800", // Dark Mode
          {
      ...
      radioButtonBox: ({ context }) => ({
        className: classNames(
          ...
          context.checked
            ...
            : "border-gray-300 bg-white dark:border-blue-900/40 dark:bg-gray-800 peer-hover:border-blue-500",
          {
      ...
      radioButtonIcon: ({ context }) => ({
        className: classNames(
          "transform rounded-full",
          "block h-3 w-3 bg-white transition duration-200 dark:bg-gray-800",
          {
    ...
    bodyRow: ({ context }) => ({
      className: classNames(
        context.selected
          ...
          : "bg-white text-gray-600 dark:bg-gray-800",
        context.stripedRows
          ? context.index % 2 === 0
            ? "bg-white text-gray-600 dark:bg-gray-800"
            : "bg-blue-50/50 text-gray-600 dark:bg-gray-850"
          : "",
        "transition duration-200",
        "focus:outline focus:outline-[0.15rem] focus:outline-blue-200 focus:outline-offset-[-0.15rem]", // Focus
    ...
    rowExpansion: "bg-white text-gray-600 dark:bg-gray-800 dark:text-white/80",
    rowGroupHeader: {
      className: classNames(
        "sticky z-[1]",
